...
/* hc_polsol.c */
void hc_polsol(struct hcs *, int, double *, int, double *, unsigned short, struct sh_lms *, unsigned short, int, double *, double *, unsigned short, struct sh_lms *, struct sh_lms *, int, struct sh_lms *, unsigned short, unsigned short);
/* hc_propagator.c */
void hc_evppot(int, double, double *);
void hc_evalpa(int, double, double, double, double *);
/* hc_solve.c */
void hc_solve(struct hcs *, unsigned short, int, struct sh_lms *, unsigned short, unsigned short, unsigned short, unsigned short, unsigned short);
...
void sh_print_parameters(struct sh_lms *, int, int, int, double, FILE *, unsigned short, unsigned short, unsigned short);
unsigned short sh_read_parameters(int *, int *, int *, int *, int *, double *, int *, FILE *, unsigned short, unsigned short, unsigned short);
void sh_print_coefficients(struct sh_lms *, int, FILE *, double *, unsigned short, unsigned short);
void sh_read_coefficients(struct sh_lms *, int, int, FILE *, unsigned short, double *, unsigned short);
void sh_read_spatial_data(struct sh_lms *, FILE *, unsigned short, int, float *, float *);
...
void sh_print_spatial_data(struct sh_lms *, int, float *, unsigned short, float, FILE *);
